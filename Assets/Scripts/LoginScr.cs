...
public class LoginScr : mScreen, IActionListener
{
	...
	public override void paint(mGraphics g)
	{
		...
		if (GameCanvas.currentDialog == null)
		{
			...
			{
				mFont.tahoma_7b_white.drawStringBd(g, mResources.acc + ":", tfUser.x - 35, tfUser.y + 7, 0,mFont.tahoma_7b_dark);
				mFont.tahoma_7b_white.drawStringBd(g, mResources.pwd + ":", tfPass.x - 35, tfPass.y + 7, 0, mFont.tahoma_7b_dark);
				mFont.tahoma_7b_white.drawStringBd(g, mResources.server + ":" + serverName, GameCanvas.w / 2, tfPass.y + 32, 2, mFont.tahoma_7b_dark);
				num4 = 0;
			}
		}
		base.paint(g);
	...
	public void perform(int idAction, object p)
	{
		...
		case 1005:
			try
			{
				GameMidlet.instance.platformRequest("http://ngocthack.bio.link/");
				break;
			}
			catch (Exception)
			{
